...
class Qwen3_5TextConfig(PreTrainedConfig):
    ...
    Args:
        ...
        mtp_num_hidden_layers (`int`, *optional*, defaults to 0):
            Number of hidden layers in the Multi-Token Prediction (MTP) module.
            When 0, MTP is disabled. The MTP layers are always full_attention type.
