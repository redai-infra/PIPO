...
class TemplateArguments:
    ...
    Args:
        ...
        min_length (Optional[int]): The minimum number of tokens for a single sample after tokenization. Samples
            with length less than this value will be filtered out (deleted). Defaults to None, meaning no minimum
            length filtering.
