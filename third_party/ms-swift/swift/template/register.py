...
def get_template(
    ...
    *,
    ...
    Args:
        ...
        min_length (Optional[int], optional): Minimum sequence length for tokenized inputs.
            Sequences shorter than this length will be filtered out during training.
            If None, no minimum length filtering is applied. Defaults to None.
