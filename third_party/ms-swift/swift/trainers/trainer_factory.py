...
class TrainerFactory:
    TRAINER_MAPPING = {
        ...
        # PIPO (Qwen3.5 compressed backbone + MTP); registered from project plugin `pipo/trainer/swift_plugin.py`
        'pipo': 'pipo.trainer.swift_sft_trainer.PIPOSeq2SeqTrainer',
    ...
    TRAINING_ARGS_MAPPING = {
        ...
        'pipo': 'swift.trainers.Seq2SeqTrainingArguments',
