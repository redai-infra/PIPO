...
from swift.template import MaxLengthError, MinLengthError, Template
...
class LazyLLMDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        for i in range(self.n_try_fetch):
            ...
            try:
                ...
                if self.strict:
                    ...
                    raise
                if isinstance(e, (MaxLengthError, MinLengthError)):
                    continue
        ...
        raise ValueError('Failed to retrieve the dataset. You can avoid this issue by increasing `max_length`, '
                         'decreasing `min_length`, or modifying the `truncation_strategy`.')
